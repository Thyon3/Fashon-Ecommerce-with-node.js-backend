...
abstract class colors {
  ...
  // DarkThemesharpColor color swatch
  static const Color DarkThemesharpColor = Color(0xff191821);

  //   DarkThemeBgDark swatch
  static const Color DarkThemeBgDark = Color(0xff0e0d11);

  //   DarkThemeDarkNavBarColor swatch
  static const Color DarkThemeDarkNavBarColor = Color(0xff201ff27);
}
